...
class GameOverState(Scene):
    IMG: str = paths.IMAGES + "/game_over.png"
    HEIGHT: int = scale_to_resolution(220)
    Y: int = scale_to_resolution(71)

    SCORE_FONT: str = paths.FONTS + "/Pixel Gosub.otf"
    SCORE_SIZE = scale_to_resolution(43.21)
    SCORE_Y = scale_to_resolution(339)
    SCORE_Y_PADDING = scale_to_resolution(-18)

    PRESS_FONT: str = paths.FONTS + "/Pixel Gosub.otf"
