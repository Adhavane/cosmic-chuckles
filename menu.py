...
class MenuState(State):
    def __init__(self, game) -> None:
        ...
        self.__credit_rect = self.credit.get_rect()
        self.__credit_rect.x = self.title_rect.x + self.title_rect.width - self.__credit_rect.width
        self.__credit_rect.y = settings.CREDIT_Y
    ...
    def draw(self) -> None:
        ...
        self.game.screen.blit(self.credit, self.__credit_rect)
